 ...
 private boolean ValidasiData(String judul, String penulis){ 
    ...
    private void hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hapusActionPerformed
        // TODO add your handling code here:
         ...
         if(HapusData(id))
             JOptionPane.showMessageDialog(null, "Berhasil hapus data broo");
         else
             JOptionPane.showConfirmDialog(null, "Gagal hapus data brooo");
    ...
    private void ubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ubahActionPerformed
        ...
        if(ubahData(id, judul, penulis, harga))
            JOptionPane.showMessageDialog(null,"Berhasil Ubah Data BROO");
        else
            JOptionPane.showConfirmDialog(null,"Gagal Ubah Data BROO");
        InitTable();TampilData();
    ...
    private void txtsearchCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_txtsearchCaretUpdate
        ...
        if(cari.getText().length()==0){
            ...
            PencarianData(cmbby.getSelectedItem().toString(),cari.getText());
        }
